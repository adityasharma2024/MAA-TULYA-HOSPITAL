...
const JSON_LD = {
  ...
  sameAs: [
    "https://www.facebook.com/your-hospital-page",
    "https://www.linkedin.com/company/your-hospital",
  ],
...
function usePrefersDark() {
  ...
  useEffect(() => {
    try {
      ...
      return () =>
        m && m.removeEventListener && m.removeEventListener("change", handler);
    } catch (err) {
      // ignore
    }
  }, []);
...
export default function Home() {
  ...
  const heroImages = useMemo(
    () => (prefersDark ? HERO_IMAGES_DARK : HERO_IMAGES_LIGHT),
    [prefersDark],
  );
  ...
  return (
    <main className="bg-white text-gray-900 antialiased">
      ...
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Maa Tulya Hospital, Baghpat hospital, emergency hospital Baghpat, multi-speciality Baghpat"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-12 lg:py-20">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-[rgba(59,52,134,0.06)] px-3 py-1 rounded-full w-max">
                ...
                <span className="text-sm text-[#3B3486] font-semibold">
                  Serving Baghpat & neighbouring districts
                </span>
              </div>
              ...
              <p className="mt-4 text-gray-600 max-w-2xl">
                Maa Tulya Hospital provides comprehensive medical services
                including emergency care, diagnostics, and specialist
                consultations with transparent pricing and a patient-focused
                approach.
              </p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  href={`tel:${PHONE}`}
                  className="inline-flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-full shadow hover:scale-105 transform transition"
                >
                  <FaPhoneAlt /> Call Now
                </a>
                ...
                <a
                  href={`mailto:${EMAIL}`}
                  className="inline-flex items-center gap-2 border border-[#3B3486] text-[#3B3486] px-4 py-2 rounded-full hover:bg-[#3B3486] hover:text-white transition transform"
                >
                  <FaEnvelope /> Email Us
                </a>
                ...
                <Link
                  to="#services"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#3B3486] text-white hover:opacity-95 transition"
                >
                  Explore Services
                </Link>
              </div>
                ...
                <div className="absolute inset-0 pointer-events-none flex items-center justify-between px-4">
                  <button
                    ...
                    onClick={() => {
                      setAutoplay(false);
                      setIndex(
                        (s) => (s - 1 + heroImages.length) % heroImages.length,
                      );
                    }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-gray-600 max-w-3xl">
              Core clinical services tailored to local needs — emergency care,
              cardiology, orthopaedics, maternity, paediatrics, diagnostics and
              more.
            </p>
          </motion.header>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-4 flex items-center gap-3">
                      <Link
                        to={`/services/${slugify(svc.title)}`}
                        className="text-[#3B3486] hover:underline"
                      >
                        Learn more
                      </Link>
                      <a
                        href={`tel:${PHONE}`}
                        className="ml-auto inline-flex items-center gap-2 bg-green-600 text-white px-3 py-1 rounded-full"
                      >
                        <FaPhoneAlt /> Call Now
                      </a>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-gray-600 max-w-2xl">
              Meet the experienced clinicians who deliver care across the
              hospital’s core departments.
            </p>
          </motion.header>
          ...
          <div className="mt-6 text-center">
            <Link
              to="/doctors"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 hover:shadow"
            >
              View all doctors
            </Link>
          </div>
      ...
      <section id="facilities" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mt-3 max-w-3xl">
            ICU, modern OTs, diagnostics, pharmacy and patient-friendly rooms
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <InfoCard
              ...
              text="Monitored ICU beds, ventilators, and trained critical care staff."
            />
            <InfoCard
              icon={<FaSyringe />}
              title="Diagnostics Lab"
              text="Rapid lab turnaround with quality controls and accurate reporting."
            />
            <InfoCard
              icon={<FaFilePdf />}
              title="Pharmacy"
              text="In-house pharmacy with essential medicines and delivery options."
            />
          </div>
        </div>
      </section>
      ...
      <section id="cost" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-gray-600 max-w-3xl">
              Transparent package pricing and options for senior citizens and
              groups.
            </p>
          </motion.header>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <PriceCard
              ...
              price="₹999"
              desc="Essential tests: CBC, glucose, lipid profile, BP, and general exam."
            />
            <PriceCard
              title="Executive Health Screen"
              price="₹3,499"
              desc="Advanced panel including ECG and liver/kidney function tests."
            />
            <PriceCard
              title="Maternity Package"
              price="Starting ₹15,000"
              desc="Antenatal visits, delivery package and immediate postpartum care."
            />
          </div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              ...
              download
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#3B3486] text-white rounded-full"
            >
            ...
            <a
              href={`tel:${PHONE}`}
              className="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-full"
            >
      ...
      <section id="reviews" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-gray-600 max-w-3xl">
              Real testimonials from patients and families who used our
              services.
            </p>
          </motion.header>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <ReviewCard
              name="Ramesh Kumar"
              date="2024-10-05"
              text="Excellent care and attentive staff. Emergency response was prompt and decisive."
            />
            <ReviewCard
              name="Priya Singh"
              date="2024-08-12"
              text="Supportive maternity team and efficient postnatal care — a safe delivery experience."
            />
            <ReviewCard
              name="Amit Verma"
              date="2024-07-20"
              text="Transparent pricing and quick recovery after surgery. Recommended."
            />
          </div>
          ...
          <div className="mt-6 text-center">
            <Link
              to="/reviews"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200"
            >
              Read all reviews
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-6">
            <FeatureCard
              ...
              text="Centrally located in Baghpat with clear directions, parking and local transport."
            />
            <FeatureCard
              title="Transparent Pricing"
              text="Clear package pricing and downloadable policy documents."
            />
            <FeatureCard
              title="Clinical Quality"
              text="Evidence-based protocols and multidisciplinary reviews for consistent care."
            />
          </div>

          <div className="mt-8">
            <p className="text-gray-700">
              Many families choose Maa Tulya over traveling to larger cities
              like Meerut — local access, lower travel burden, and reliable
              follow-up care make a practical difference.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            <FAQ
              ...
              a={`Call our helpline: ${PHONE} — available 24/7.`}
            />
            <FAQ
              q="Do you accept insurance?"
              a="We facilitate cashless admissions with multiple insurers; please confirm with billing."
            />
            <FAQ
              q="What are visiting hours?"
              a="Visiting hours vary by department; call ahead for specifics for ICU or postoperative wards."
            />
            <FAQ
              q="How quickly are lab reports available?"
              a="Most routine lab reports are available within 24 hours; urgent tests are faster."
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mt-3 max-w-xs">
              Comprehensive multi-speciality care in Baghpat with focus on
              clinical quality, accessibility and affordability.
            </p>
        ...
        <div className="border-t border-gray-800 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm">
            ...
            <div className="mt-3 md:mt-0">
              ...
              <strong className="text-green-600">ADITYA SHARMA</strong>
            </div>
          </div>
        </div>
      </footer>
...
function StatCard({ label, value, icon }) {
  return (
    <motion.div
      ...
      className="bg-white p-3 rounded-lg shadow flex items-center gap-3 border"
    >
  ...
  return (
    ...
    >
      ...
      <div className="mt-4">
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 px-3 py-2 bg-[#3B3486] text-white rounded-full"
        >
          Discuss Package
        </Link>
      </div>
  ...
  return (
    ...
    >
      ...
      <footer className="mt-3 text-sm text-gray-500">
        — {name} • <time dateTime={date}>{date}</time>
      </footer>
    </motion.blockquote>
  );
}
  ...
  return (
    <section aria-label="extended-content" className="hidden">
      ...
      <div>
        ...
        <p>
          Maa Tulya Hospital's mission is to deliver accessible, high-quality
          medical care to the people of Baghpat and surrounding areas. The
          hospital focuses on strong clinical governance, staff training, and
          patient safety systems to ensure outcomes and trust.
        </p>

        <h3>Clinical Services</h3>
        <p>
          Cardiology: The cardiology unit offers preventive evaluation,
          monitoring, emergency chest pain protocols, and post-discharge
          follow-up. Orthopaedics: Comprehensive fracture care, arthroplasty,
          arthroscopy, and rehabilitation programs.
        </p>

        <h3>Patient Support</h3>
        <p>
          Patient navigation and billing transparency ensure that families can
          make clear, informed decisions. For those requiring financial
          flexibility, the hospital provides information about EMI options and
          insurance coverage.
        </p>
        ...
        <p>
          Access to timely care saves lives. Choosing a nearby multi-speciality
          facility reduces travel delays for emergencies and ensures continuity
          of follow-up care.
        </p>
      </div>
    </section>
